...
function PlaneDetail() {
  ...
  const isLoading = useSelector((state) => state.userCredential.isLoading);
        ...
        <React.Fragment>
          ...
          <Grid templateColumns='repeat(2,1fr)' gap={6}>
            <GridItem w='100%' alignSelf='center'>
              ...
              <Text>
                This cat happen now, it was too purr-fect!!! fight own tail.
                Nyan nyan goes the cat, scraaaaape scraaaape goes the walls when
                the cat murders them with its claws. Poop on grasses drool and
                making sure that fluff gets into the owner's eyes so sit as
                close as possible to warm fire without sitting on cold floor.
                Rub face on owner if it fits i sits yet just going to dip my paw
                in your coffee and do a taste test - oh never mind i forgot i
                don't like coffee - you can have that back now more napping,
